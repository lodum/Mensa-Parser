...
public class TripleStoreBridge {
	 ...
	 *            the target graph
	 * @param prefix
	 *            any kind of prefixes for the triples
	 * 
	 * @throws IOException
	 */
	public static void insertData(String endpoint, final String username,
			final String password, String msg, String graph, String prefix)
			throws IOException {
		...
		stringBuilder
				.append("<http://data.uni-muenster.de/context/food/food-additive10> gr:description \"contains traces of phenylalanine\"@en, \"enthält eine Phenylalaninquelle\"@de .");
		stringBuilder.append("\n");
		stringBuilder
				.append("<http://data.uni-muenster.de/context/food/food-additive12> gr:description \"contains alcohol\"@en, \"enthält Alkohol\"@de .");
		stringBuilder.append("\n");
		stringBuilder
		...
		stringBuilder.append("\n");
		stringBuilder
				.append("<http://data.uni-muenster.de/context/food/food-additive4> gr:description \"contains flavour enhancers\"@en, \"mit Geschmacksverstärker\"@de .");
		stringBuilder.append("\n");
		stringBuilder
				.append("<http://data.uni-muenster.de/context/food/food-additive5> gr:description \"geschwefelt\"@de, \"treated with sulphur\"@en .");
		stringBuilder.append("\n");
		stringBuilder
				.append("<http://data.uni-muenster.de/context/food/food-additive6> gr:description \"geschwärzt\"@de, \"stained black\"@en .");
		stringBuilder.append("\n");
		stringBuilder
		...
		stringBuilder.append("\n");
		stringBuilder
				.append("<http://data.uni-muenster.de/context/food/food-additive9> gr:description \"contains sweetener\"@en, \"mit Süssungsmittel\"@de .");
		stringBuilder.append("\n");
		...
		msg = "update= " + prefix + deleteTimestamp + "INSERT DATA{ GRAPH "
				+ graph + " \n {" + metadata + msg + "}}";

		// enable basic HTTP auuthentication:
